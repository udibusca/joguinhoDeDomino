...
public class DominoCliente extends JFrame {
	...
	private void jButton1ActionPerformed(ActionEvent evt) {
		...
		try {
			...
			javax.swing.JOptionPane.showMessageDialog(null, " Erro de conexão (Cliente)", " COD 1 - Exit",
	...
	void voltas() {
		...
		if (cursor != null && (j.Move(cursor.lado1) || j.Move(cursor.lado2))) {
			try {
				...
				javax.swing.JOptionPane.showMessageDialog(null, " Erro de conexão (Cliente)", " COD 2 - Exit",
						javax.swing.JOptionPane.OK_OPTION);
			...
			if (!(j instanceof JogadorVirtual))
				...
				javax.swing.JOptionPane.showMessageDialog(null, "Eu não tenho",
			...
			try {
				...
				javax.swing.JOptionPane.showMessageDialog(null, " Erro de conexão (Cliente)", " COD 3 - Exit",
						javax.swing.JOptionPane.OK_OPTION);
